...
public sealed class CharacterController : MonoBehaviour {
	...
	void Start () {
		playerBehavior = new Dictionary<string, Action> {
			...
			{"lighOnOff", 		() => fleshLight.enabled = !fleshLight.enabled},
		};
	}
	...
	private void checkPlayerBehavior() {
		...
		if (CollisionController.instance.inFlight && playerRigidBody.drag > 0f) { playerRigidBody.drag = 0f; } 
		if (!CollisionController.instance.inFlight  && playerRigidBody.drag < 15f) { playerRigidBody.drag = 15f; }
	...
	private void cacheComponents() {
		...
		_cameraTr = camera.transform.GetComponent<Transform> ();
	}
	...
	public float sensivity {
		...
		set { this._sensivity = value; }
	}

	public Quaternion playerRotation {
		get { return this._playerTr.rotation; }
		set { this._playerTr.rotation = value; }
	}
	...
	public Quaternion cameraRotation {
		...
		set { this._cameraTr.rotation = value; }
	}

	public Transform cameraTr {
		get { return this._cameraTr; }
		set { this._cameraTr = value; }
	}
